...
namespace ImGui
{
    ...
    IMGUI_API bool          TreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end = NULL, ImTextureID texture = nullptr, ImVec2& size = ImVec2(0, 0));
